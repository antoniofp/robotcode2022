...
//Creating objects for chassis motors
  CANSparkMax m_frontleftMotor = new CANSparkMax(1, MotorType.kBrushless);
  CANSparkMax m_backleftMotor = new CANSparkMax(2, MotorType.kBrushless);
  CANSparkMax m_frontrightMotor = new CANSparkMax(3, MotorType.kBrushless);
  CANSparkMax m_backrightMotor = new CANSparkMax(4, MotorType.kBrushless);
//Grouping Left chassis motors and right chassis motors
  final MotorControllerGroup leftMotors = new MotorControllerGroup(m_frontleftMotor, m_backleftMotor);
  final MotorControllerGroup rightMotors = new MotorControllerGroup(m_frontrightMotor, m_backrightMotor);
...
//keep intake up by default
  ...
  public void robotPeriodic() { //Class used all time
    ...
    SmartDashboard.putNumber("Climber L", leftClimbEncoder.getPosition());
